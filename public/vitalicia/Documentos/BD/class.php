...
{
$conexion = mysqli_connect("mysql.hostinger.mx","u435473506_netit","patito01","u435473506_netit");
...
public function insertarempleado($nombre_emple, $loc, $tel)
{
$conexion = mysqli_connect("mysql.hostinger.mx","u435473506_netit","patito01","u435473506_netit");
$sempl = "CALL insertarempleado('".$nombre_emple."','".$loc."','".$tel."')";
