...
// $consultasql = "DELETE from encargado where id_enc=".$_POST['id']."";
...
$resultadosql = mysqli_query($con, "DELETE from encargado where id_enc=".$_POST['id']."")or die("¡No se ha podido eliminar el registro!");
print "<h3 style='text-align:center;'>Registro eliminado</h3>";
?>
</body>
</html>