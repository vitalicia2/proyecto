...
// $consultasql = "DELETE from servicios where id_serv=".$_POST['id']."";
...
$resultadosql = mysqli_query($con,"DELETE from servicios where id_serv=".$_POST['id']."")or die("¡No se ha podido eliminar el registro!");
print "<h3 style='text-align:center;'>Registro eliminado</h3>";
?>
</body>
</html>