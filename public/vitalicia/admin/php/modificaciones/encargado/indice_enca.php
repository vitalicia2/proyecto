			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Modificar datos del Encargado</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Modificar datos del Encargado</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query ($con,"SELECT id_emp,id_serv,id_enc,grado_estudios FROM encargado");
if (! $result){
...
<form action="modificar_enca.php" method="POST">
    <td><label >Id de encargado:</label></td><td><input type="text" name="idenc"></td>
	<td><label >Identificador de empleado:</label></td><td><input type="text" name="idemp"></td>
	<td><label >Identificador de servicio:</label></td><td><input type="text" name="idserv"></td>
	<td><label >Grado de estudios:</label></td><td><input type="text" name="grades"></td>
