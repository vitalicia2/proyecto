			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Modificar datos de Cliente</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Modificar datos del cliente</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query($con,"SELECT id,nom,ap,am,tel,dir,em FROM cliente");
if ($result=$result){
    echo "<table><tr><td>Id cliente</td><td>Nombre</td><td>Apellido paterno</td><td>Apellido materno</td><td>Telefono</td><td>E-mail</td><td>Direccion</td>
         </tr><tr>";
...
<form action="modificar_cli.php" method="POST">
  <table>
    <td>Id del cliente:</td><td><input type="text" name="nombre"></td>
	<td>Nombre:</label></td><td><input type="text" name="nom"></td>
	<td>Apellido Paterno:</td><td><input type="text" name="app" ></td>
    <td>Apellido Materno:</td><td><input type="text" name="apm"></td><tr>
	<td>Telefono</td><td><input type="text" name="tel"></td>
	<td>Email</td><td><input type="text" name="em"></td>
	<td>Direccion</td><td><input type="text" name="ddir"></td>
    <td><td><input class="btn btn primary" type="submit" value="Guardar"></td></td>
	</table>
</form>
</div>
</div>
