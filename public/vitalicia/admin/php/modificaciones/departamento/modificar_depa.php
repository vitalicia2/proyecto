			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Modificar datos de Departamento</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Modificar datos del Departamento</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query ($con, "SELECT id_dep,nombre FROM departamento");
...
<form action="modifi_dep.php" method="POST">
    <td><label >Id del departamento:</td><td><input type="text" name="id_dep"></td>
	<td><label >Nombre del departamento:</label></td><td><input type="text" name="nom"></td>
	<td><td><input class="btn btn primary" type="submit" value="Modificar"></td>
</form>
</div>
</div>
</div>
