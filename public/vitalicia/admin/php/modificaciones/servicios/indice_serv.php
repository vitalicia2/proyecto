			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Modificar datos del Servicio</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Modificar datos del Servicio</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query ($con,"SELECT id_serv,nombre,id,id_dep,id_enc FROM servicios");
...
<form action="modificar_serv.php" method="POST">
    Id servicio:<input type="text" name="idserv">
	Nombre del servicio:<input type="text" name="nser">
	Identificador:</td><td><input type="text" name="iden">
	Identificador del departamento:<input type="text" name="iddep">
	Identificador del encargado:<input type="text" name="idenc">
