			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Consulta de datos del Servicios</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Consulta de datos del Servicio</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query ($con, "SELECT p.nombre, p.id ,p.id_dep FROM servicios AS p WHERE(p.nombre LIKE '%".$_POST['nombre']."%')");
