			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Consulta de datos del Encargado</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Consulta de datos del Encargado</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query ($con,"SELECT e.id_emp,e.id_serv,e.id_enc,e.grado_estudios FROM encargado AS e WHERE(e.grado_estudios LIKE '%".$_POST['nombre']."%' OR e.id_emp LIKE '%".$_POST['nombre']."%' OR e.id_serv LIKE '%".$_POST['nombre']."%')");
if (! $result){
