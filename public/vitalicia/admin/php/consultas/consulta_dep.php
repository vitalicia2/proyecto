			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Consulta de datos del Departamento</a>  
		        </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Consulta de datos del Departamento</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
$result = mysqli_query ($con, "SELECT d.id_dep,d.nombre FROM departamento AS d WHERE(d.nombre LIKE '%".$_POST['nombre']."%')");
if (! $result){
