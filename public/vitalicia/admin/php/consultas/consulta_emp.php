			...
			<div class="container">
		        ...
		        <div class="navbar-header">
					...
					<a href="#" class="js-insideV-nav-toggle insideV-nav-toggle" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"><i></i></a>
		          	<a class="navbar-brand">Net IT Solutions | Consulta de datos del Empleado</a>  
		        </div>
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
                    <li><a href="../../consultas.html" ><span>Regresar</span></a></li> 
		          </ul>
		        </div>
			    </nav>
			  </div>
...
<div class="row row-bottom-padded-sm">
    <div class="col-md-12 section-heading text-center">
            <h2 class="to-animate">Consulta de datos del Empleado</h2>
    </div>
</div>
<div align=center>
<div class="row">
...
<?php
   ...
   $result = mysqli_query($con,"SELECT e.id_emp,e.nombre,e.localidad,e.telefono FROM empleados AS e WHERE(e.nombre LIKE '%".$_POST['nombre']."%' OR e.id_emp LIKE '%".$_POST['nombre']."%' OR e.localidad LIKE '%".$_POST['nombre']."%' OR e.telefono LIKE '%".$_POST['nombre']."%')");
   if (!$result){
