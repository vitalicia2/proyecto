	...
	<header role="banner" id="insideV-header">
        ...
        <br>
				...
				<div class="col-md-12 section-heading text-center">
					<h2>Informaci&oacute;n de Cita</h2>
				</div>
                </div>
    ...
    <div class="row row-bottom-padded-sm">
        <div class="col-md-12 section-heading text-center"> 
            ...
            <div class="col-md-12">
                ...
                <table class="hover">
                <tr><td >Folio de cita</td><td >Fecha</td><td >Hora</td><td >Turno</td></Tr>
                @foreach($resultado as $res)
                <tr><td >{{$res->idcitas}}</td><td >{{$res->fecha}}</td><td >{{$res->hora}}</td><td>{{$res->horaturno}}</td>
            ...
            <div class="col-md-12">
                <div class="form-group" align='center'>
                    ...
                    <a href="{{URL::action('ControlCitas@cita')}}" type="button" class='btn btn-outline' name="cancelar" id="cancelar" >Regresar</a>
